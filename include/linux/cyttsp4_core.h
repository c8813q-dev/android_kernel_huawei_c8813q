...
/* data of release*/
#define CY_DRIVER_DATE "20130105"	/* YYYYMMDD */
...
struct cyttsp4_loader_platform_data {
	...
	struct cyttsp4_sett_param_map *param_map; //use by upgrade config
	u32 flags;
} __packed;
...
struct cyttsp4_core_platform_data {
	...
	unsigned use_configure_sensitivity:1; //node of the glove 
