...
/*use new AWB golden module: #129*/
int RG_Ratio_Typical =0x29A;//0x2C6;//0x293;//;//0x29E;//use #64 module 0x2A8;
int BG_Ratio_Typical =0x2D5;//0x2C6;//0x2C8;//;//0x2C8;//use #64 module 0x280;
