...
static struct msm_camera_i2c_reg_conf s5k4e1_recommend_settings_4_liteon[] = {
	{0x3096, 0x40},
...
static struct msm_camera_i2c_reg_conf s5k4e1_recommend_settings_4_flip[] = {
	{0x3096, 0x40},
...
static struct msm_camera_i2c_conf_array s5k4e1_init_conf_liteon[] = {
	{&s5k4e1_recommend_settings_1[0],
	ARRAY_SIZE(s5k4e1_recommend_settings_1), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&s5k4e1_recommend_settings_2[0],
	ARRAY_SIZE(s5k4e1_recommend_settings_2), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&s5k4e1_recommend_settings_3[0],
	ARRAY_SIZE(s5k4e1_recommend_settings_3), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&s5k4e1_recommend_settings_4_liteon[0],
	ARRAY_SIZE(s5k4e1_recommend_settings_4_liteon), 0, MSM_CAMERA_I2C_BYTE_DATA},
};
static struct msm_camera_i2c_conf_array s5k4e1_init_conf_flip[] = {
	{&s5k4e1_recommend_settings_1[0],
	ARRAY_SIZE(s5k4e1_recommend_settings_1), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&s5k4e1_recommend_settings_2[0],
	ARRAY_SIZE(s5k4e1_recommend_settings_2), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&s5k4e1_recommend_settings_3[0],
	ARRAY_SIZE(s5k4e1_recommend_settings_3), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&s5k4e1_recommend_settings_4_flip[0],
	ARRAY_SIZE(s5k4e1_recommend_settings_4_flip), 0, MSM_CAMERA_I2C_BYTE_DATA},
};
...
static int s5k4e1_update_otp(void)
{
    int R_gain, G_gain, B_gain, G_gain_R, G_gain_B;
    int rg,bg;
    if(0 == g_s5k4e1_otp_awb[0])
    {
        printk(KERN_ERR "%s: no otp data\n",__func__);
        return 0;
    }
    
    rg = g_s5k4e1_otp_awb[0];
    bg = g_s5k4e1_otp_awb[1];
    ...
    printk(KERN_INFO "%s: R_gain =0x%04x, G_gain =0x%04x, B_gain =0x%04x \n", __func__,R_gain,G_gain,B_gain);
    printk(KERN_INFO "%s: otp r_g = 0x%04x, b_g = 0x%04x\n",__func__,rg,bg);
    if (R_gain>0x100) {
       //digital_gain_R
        msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x0210, R_gain>>8, MSM_CAMERA_I2C_BYTE_DATA);
        msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x0211, R_gain & 0x00ff, MSM_CAMERA_I2C_BYTE_DATA);
    }

    if (G_gain>0x100) {
        //digital_gain_greenR
        msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x020E, G_gain>>8, MSM_CAMERA_I2C_BYTE_DATA);
        msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x020F, G_gain & 0x00ff, MSM_CAMERA_I2C_BYTE_DATA);

        //digital_gain_greenB
        msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x0214, G_gain>>8, MSM_CAMERA_I2C_BYTE_DATA);
        msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x0215, G_gain & 0x00ff, MSM_CAMERA_I2C_BYTE_DATA);
    }

    if (B_gain>0x100) {
        //digital_gain_B
        msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x0212, B_gain>>8, MSM_CAMERA_I2C_BYTE_DATA);
        msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x0213, B_gain & 0x00ff, MSM_CAMERA_I2C_BYTE_DATA);
    }
...
int s5k4e1_read_layer_data(int layer)
{
	uint16_t otpData = 0;

	/* select the layer */
	msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x310C, layer, MSM_CAMERA_I2C_BYTE_DATA);

	/* read 0x310D LSB */
	 msm_camera_i2c_read(s5k4e1_s_ctrl.sensor_i2c_client, 0x310D, &otpData, MSM_CAMERA_I2C_BYTE_DATA);
     ...
     /* read 0x310E MSB */
	 msm_camera_i2c_read(s5k4e1_s_ctrl.sensor_i2c_client, 0x310E, &otpData, MSM_CAMERA_I2C_BYTE_DATA);
	 otpData = otpData >> 4;
	 if(0 != otpData)
	 {
	 	return otpData;
	 ...
	 /* read 0x310F MSB */
	 msm_camera_i2c_read(s5k4e1_s_ctrl.sensor_i2c_client, 0x310F, &otpData, MSM_CAMERA_I2C_BYTE_DATA);
	 otpData = otpData >> 4;
	 if(0 != otpData)
	 {
	 	return otpData;
...
static uint16_t s5k4e1_read_rg(void)
{
	uint16_t otpData = 0;
	uint16_t rg = 0;
		
    /*read RG */
	otpData = s5k4e1_read_layer_data(28);
	rg = otpData << 12;

	otpData = s5k4e1_read_layer_data(29);
	rg |= otpData << 8;

	otpData = s5k4e1_read_layer_data(30);
	rg |= otpData << 4;

	otpData = s5k4e1_read_layer_data(31);
	rg |= otpData ;

	return rg;
}

static uint16_t s5k4e1_read_bg(void)
{
	uint8_t otpData = 0;
	uint16_t bg = 0;
	
    /*read RG */
	otpData = s5k4e1_read_layer_data(32);
	bg = otpData << 12;

	otpData = s5k4e1_read_layer_data(33);
	bg += otpData << 8;

	otpData = s5k4e1_read_layer_data(34);
	bg += otpData << 4;

	otpData = s5k4e1_read_layer_data(35);
	bg += otpData ;

	return bg;
}

static int s5k4e1_otp_data_read(void)
{
	uint16_t rg = 0;
	uint16_t bg = 0;
	...
	msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x30F9, 0x0E, MSM_CAMERA_I2C_BYTE_DATA);

	msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x30FA, 0x0A, MSM_CAMERA_I2C_BYTE_DATA);

	msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x30FB, 0x71, MSM_CAMERA_I2C_BYTE_DATA);

	msm_camera_i2c_write(s5k4e1_s_ctrl.sensor_i2c_client, 0x30FB, 0x70, MSM_CAMERA_I2C_BYTE_DATA);
	...
	g_s5k4e1_otp_awb[0] = rg;
	g_s5k4e1_otp_awb[1] = bg;
	
        g_modeID = s5k4e1_read_layer_data(26);
	
	printk("%s rg = 0x%04x, bg = 0x%04x ,modeID = %d, DataTime:%d%d%d%d%d%d \n",
		__func__, rg, bg, g_modeID,
		s5k4e1_read_layer_data(18), s5k4e1_read_layer_data(19),
		s5k4e1_read_layer_data(20), s5k4e1_read_layer_data(21),
		s5k4e1_read_layer_data(22), s5k4e1_read_layer_data(23));
...
static int32_t s5k4e1_sensor_model_match(struct msm_sensor_ctrl_t *s_ctrl)
{
    ...
    {
        s_ctrl->msm_sensor_reg->init_settings = &s5k4e1_init_conf_flip[0];
        s_ctrl->msm_sensor_reg->init_size = ARRAY_SIZE(s5k4e1_init_conf_flip);
    }
	if(S5k4E1_MODE_LITEON == s5k4e1_mode_type)
	{
		if(0 != s5k4e1_otp_data_read())
		{
			printk("%s: liteon module no data in OTP!\n", __func__);
			return -1; 
		}
		else
		{
			s_ctrl->msm_sensor_reg->init_settings = &s5k4e1_init_conf_liteon[0];
			s_ctrl->msm_sensor_reg->init_size = ARRAY_SIZE(s5k4e1_init_conf_liteon);
		}
	}
	return 0;
}
static int32_t s5k4e1_sensor_setting(struct msm_sensor_ctrl_t *s_ctrl,
